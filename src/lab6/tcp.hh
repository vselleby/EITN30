...
class TCPConnection
{
 public:
  ...
  udword sentMaxSeq;
  //the sequence number of the last sent byte.

  bool resetFlag;
  //true if rst-flag received
...
{
public:
	RetransmitTimer(TCPConnection* theConnection, Duration retransmitTime);
	void start();
	void cancel();
private:
	void timeOut();
...
class RSTTimer : public Timed
{
public:
	RSTTimer(TCPConnection* theConnection, Duration time);
	void start();
	void cancel();
private:
	void timeOut();
